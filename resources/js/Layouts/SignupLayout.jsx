...
export default function SignupLayout({ children }) {
    return (
        <div className="min-h-screen flex flex-col">
            {/* Top Navigation Bar - Same color as right sidebar */}
            ...
            <div className="flex flex-1">
                {/* Left Section - White Signup Form - Full width on mobile/tablet */}
                ...
                {/* Right Section - Same gradient as navigation - Hidden on mobile/tablet */}
                <div className="hidden lg:flex w-1/2 bg-gradient-to-r from-[#000000] to-[#04095D] items-center justify-center p-6 lg:p-8">
