                ...
                <div className="w-full max-w-xs sm:max-w-sm md:max-w-md">
                    ...
                    <div className="mb-8">
                        <div className="flex items-center justify-between mb-2">
                            <div className={`flex items-center ${currentStep >= 1 ? 'text-[#04095D]' : 'text-gray-400'}`}>
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                                    currentStep >= 1 ? 'bg-[#04095D] text-white' : 'bg-gray-200 text-gray-400'
                                }`}>
                                    1
                                </div>
                                <span className="ml-2 text-sm font-medium">Personal Info</span>
                            </div>
                            <div className={`flex-1 h-1 mx-2 ${currentStep >= 2 ? 'bg-[#04095D]' : 'bg-gray-200'}`}></div>
                            <div className={`flex items-center ${currentStep >= 2 ? 'text-[#04095D]' : 'text-gray-400'}`}>
                                <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-semibold ${
                                    currentStep >= 2 ? 'bg-[#04095D] text-white' : 'bg-gray-200 text-gray-400'
                                }`}>
                                    2
                                </div>
                    ...
                    <form onSubmit={currentStep === 2 ? submit : (e) => { e.preventDefault(); nextStep(); }}>
                                ...
                                <div className="grid grid-cols-1 gap-4">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg bg-white border rounded-xl sm:rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#04095D] focus:border-transparent transition-all text-gray-900 placeholder:text-gray-400 ${
                                                fieldErrors.first_name ? 'border-red-500 animate-pulse' : 'border-gray-300'
                                            } ${
                                                shakeFields.first_name ? 'animate-shake' : ''
                                            }`}
                                        ...
                                        {fieldErrors.first_name && (
                                            <p className="mt-1 text-sm text-red-600 animate-fade-in">{fieldErrors.first_name}</p>
                                        )}
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={`w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg bg-white border rounded-xl sm:rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#04095D] focus:border-transparent transition-all text-gray-900 placeholder:text-gray-400 ${
                                                fieldErrors.last_name ? 'border-red-500 animate-pulse' : 'border-gray-300'
                                            } ${
                                                shakeFields.last_name ? 'animate-shake' : ''
                                            }`}
                                        ...
                                        {fieldErrors.last_name && (
                                            <p className="mt-1 text-sm text-red-600 animate-fade-in">{fieldErrors.last_name}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className={`w-full px-4 sm:px-6 py-3 sm:py-4 text-base sm:text-lg bg-white border rounded-xl sm:rounded-2xl focus:outline-none focus:ring-2 focus:ring-[#04095D] focus:border-transparent transition-all text-gray-900 ${
                                            fieldErrors.birthdate ? 'border-red-500 animate-pulse' : 'border-gray-300'
                                        } ${
                                            shakeFields.birthdate ? 'animate-shake' : ''
                                        }`}
                                        onChange={(e) => {
                                    ...
                                    {fieldErrors.birthdate && (
                                        <p className="mt-1 text-sm text-red-600 animate-fade-in">{fieldErrors.birthdate}</p>
                                    )}
                                </div>
                                    ...
                                    {passwordStrength && (
                                        <div className="mt-2">
                                            ...
                                            <div className="mt-1 space-y-1">
                                                <div className={`flex items-center text-xs ${data.password.length >= 8 ? 'text-green-600' : 'text-gray-400'}`}>
                                                    <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                    </svg>
                                                    At least 8 characters
                                                </div>
                                                <div className={`flex items-center text-xs ${data.password.match(/[a-z]/) && data.password.match(/[A-Z]/) ? 'text-green-600' : 'text-gray-400'}`}>
                                                    <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                    </svg>
                                                    Upper & lowercase letters
                                                </div>
                                                <div className={`flex items-center text-xs ${data.password.match(/[0-9]/) ? 'text-green-600' : 'text-gray-400'}`}>
                                                    <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                    </svg>
                                                    At least one number
                                                </div>
                                                <div className={`flex items-center text-xs ${data.password.match(/[^a-zA-Z0-9]/) ? 'text-green-600' : 'text-gray-400'}`}>
                                                    <svg className="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                                                    </svg>
                                                    Special character (!@#$%^&*)
